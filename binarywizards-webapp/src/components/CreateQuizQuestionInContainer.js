  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex items-start gap-2">
        <div
          className={`flex flex-col w-[30vh] h-[15vh] items-center justify-center bg-gradient-to-b ${color} rounded-lg p-2 shadow-lg cursor-pointer border-[#8B2DF1] border-2`}
...
export function QuestionInContainerDefault({
  ...
  return (
    <div className="flex flex-col pt-5 items-center gap-2">
      ...
      <div className="flex items-start gap-2">
        <div
          className={`flex flex-col w-[30vh] h-[15vh] items-center justify-center bg-gradient-to-b ${color} cursor-pointer rounded-lg p-2 shadow-lg border-[#8B2DF1] border-2`}
